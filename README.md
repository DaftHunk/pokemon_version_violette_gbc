...
- Nivellement dynamique des arènes 4,5 et 6 pour pouvoir les faires dans l'ordre qu'on veut 
...
- Rééquilibrage des attaques, types, stats et niveaux : le but n'est pas d'être compétitif mais de rendre les choses plus intéressantes à jouer
...
- Tous les dresseurs seront nivelés à votre niveau
...
![Capture d’écran 2025-05-21 152848](https://github.com/user-attachments/assets/159de53a-473c-488f-9a3e-97acb7cfdad6)
...
- Bill vous donnera accès à un changement de boîte PC à distance
...
- **PV infini** : 01FF16D0
- **Remplacer les Pokémons sauvages** : 00XXD8CF (Remplacer XX pour l'[id $XX du Pokémon](https://github.com/DaftHunk/pokemon_version_violette/blob/master/constants/pokemon_constants.asm))
- **Remplacer le premier object du sac et l'avoir à l'infini** : 00XX22D3 (Remplacer XX pour l'[id $XX de l'objet](https://github.com/DaftHunk/pokemon_version_violette/blob/master/constants/item_constants.asm))
