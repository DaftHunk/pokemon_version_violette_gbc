...
const_value = 1
	...
	add_tx_pre Route11UpstairsBinocularsText        ; 1B
	add_tx_pre Route12UpstairsBinocularsText        ; 1C
	add_tx_pre Route16UpstairsBinocularsText        ; 1D
	add_tx_pre Route18UpstairsBinocularsText        ; 1E
	...
	add_tx_pre Route11UpstairsBinocularsNoSnorlaxText
