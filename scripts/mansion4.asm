...
Mansion4TrainerHeader0:
	dbEventFlagBit EVENT_BEAT_POKEMON_MANSION_B1F_TRAINER_0
	db ($0 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_POKEMON_MANSION_B1F_TRAINER_0
...
Mansion4TrainerHeader1:
	dbEventFlagBit EVENT_BEAT_POKEMON_MANSION_B1F_TRAINER_1
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_POKEMON_MANSION_B1F_TRAINER_1
