...
SSAnne8TrainerHeader0:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_0
	db ($2 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_0
...
SSAnne8TrainerHeader1:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_1
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_1
...
SSAnne8TrainerHeader2:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_2
	db ($2 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_2
...
SSAnne8TrainerHeader3:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_3
	db ($2 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_3
