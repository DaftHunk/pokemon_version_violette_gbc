...
Mansion3TrainerHeader0:
	dbEventFlagBit EVENT_BEAT_POKEMON_MANSION_3F_TRAINER_0
	db ($0 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_POKEMON_MANSION_3F_TRAINER_0
...
Mansion3TrainerHeader1:
	dbEventFlagBit EVENT_BEAT_POKEMON_MANSION_3F_TRAINER_1
	db ($2 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_POKEMON_MANSION_3F_TRAINER_1
