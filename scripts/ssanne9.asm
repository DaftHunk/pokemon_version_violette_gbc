...
SSAnne9TrainerHeader0:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_0
	db ($2 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_0
...
SSAnne9TrainerHeader1:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_1
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_1
...
SSAnne9TrainerHeader2:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_2
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_2
...
SSAnne9TrainerHeader3:
	dbEventFlagBit EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_3
	db ($2 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_3
