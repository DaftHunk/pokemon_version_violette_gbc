...
RockTunnel2TrainerHeader0:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_0
	db ($4 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_0
...
RockTunnel2TrainerHeader1:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_1
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_1
...
RockTunnel2TrainerHeader2:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_2
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_2
...
RockTunnel2TrainerHeader3:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_3
	db ($4 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_3
...
RockTunnel2TrainerHeader4:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_4
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_4
...
RockTunnel2TrainerHeader5:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_5
	db ($4 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_5
...
RockTunnel2TrainerHeader6:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_6
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_6
...
RockTunnel2TrainerHeader7:
	dbEventFlagBit EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_7, 1
	db ($3 << 4) ; trainer's view range
	dwEventFlagAddress EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_7, 1
