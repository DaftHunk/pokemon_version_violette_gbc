...
; Yellow
	const MUSIC_YELLOW_INTRO
	const MUSIC_SURFING_PIKACHU
	const MUSIC_MEET_JESSIE_JAMES
; Beta
	const MUSIC_GIOVANNI_SONG
	const MUSIC_DIGLETTS_CAVE
	const MUSIC_ROUTE_3_EARLY
	const MUSIC_TRADE_SONG
	const MUSIC_BATTLE_VICTORY_GUIDE
	const MUSIC_REST_PALLET
; TCG
	const MUSIC_TCG_PAUSE_MENU
