...
DEF NUM_CITY_MAPS EQU const_value
	...
	mapconst ROUTE_16,                   10, 20 ; $1B
	mapconst ROUTE_16_WEST,              21, 20 ; $1C
	mapconst ROUTE_17,                   72, 10 ; $1D
	mapconst ROUTE_18,                    9, 25 ; $1E
	mapconst ROUTE_19,                   27, 10 ; $1F
	mapconst ROUTE_20,                   10, 50 ; $20
	...
	mapconst OAKS_LAB,                    6,  5 ; $2A
	mapconst VIRIDIAN_POKECENTER,         4,  7 ; $2B
	mapconst VIRIDIAN_MART,               4,  4 ; $2C
	mapconst VIRIDIAN_SCHOOL,             4,  4 ; $2D
	mapconst VIRIDIAN_NICKNAME_HOUSE,     4,  4 ; $2E
	mapconst VIRIDIAN_GYM,                9, 10 ; $2F
	mapconst DIGLETTS_CAVE_ROUTE_2,       4,  4 ; $30
	mapconst VIRIDIAN_FOREST_EXIT,        4,  5 ; $31
	mapconst ROUTE_2_TRADE_HOUSE,         4,  4 ; $32
	mapconst ROUTE_2_GATE,                4,  5 ; $33
	mapconst VIRIDIAN_FOREST_ENTRANCE,    4,  5 ; $34
	mapconst VIRIDIAN_FOREST,            24, 17 ; $35
	mapconst MUSEUM_1F,                   4, 10 ; $36
	mapconst MUSEUM_2F,                   4,  7 ; $37
	mapconst PEWTER_GYM,                  7,  5 ; $38
	mapconst PEWTER_NIDORAN_HOUSE,        4,  4 ; $39
	mapconst PEWTER_MART,                 4,  4 ; $3A
	mapconst PEWTER_SPEECH_HOUSE,         4,  4 ; $3B
	mapconst PEWTER_POKECENTER,           4,  7 ; $3C
	mapconst MT_MOON_1F,                  18, 20 ; $3D
	mapconst MT_MOON_B1F,                 14, 14 ; $3E
	mapconst MT_MOON_B2F,                 18, 20 ; $3F
	mapconst CERULEAN_TRASHED_HOUSE,      4,  4 ; $40
	mapconst CERULEAN_MELANIES_HOUSE,     4,  4 ; $41
	mapconst CERULEAN_POKECENTER,         4,  7 ; $42
	mapconst CERULEAN_GYM,                7,  5 ; $43
	...
	mapconst ROUTE_12_GATE_1F,            4,  5 ; $59
	mapconst BILLS_HOUSE,                 4,  4 ; $5A
	mapconst VERMILION_POKECENTER,        4,  7 ; $5B
	mapconst POKEMON_FAN_CLUB,            4,  4 ; $5C
	mapconst VERMILION_MART,              4,  4 ; $5D
	mapconst VERMILION_GYM,               9,  5 ; $5E
	mapconst VERMILION_PIDGEY_HOUSE,      4,  4 ; $5F
	mapconst VERMILION_DOCK,              6, 14 ; $60
	mapconst SS_ANNE_1F,                  9, 20 ; $61
	mapconst SS_ANNE_2F,                  9, 20 ; $62
	mapconst SS_ANNE_3F,                  3, 10 ; $63
	mapconst SS_ANNE_B1F,                 4, 15 ; $64
	mapconst SS_ANNE_BOW,                 7, 10 ; $65
	mapconst SS_ANNE_KITCHEN,             8,  7 ; $66
	mapconst SS_ANNE_CAPTAINS_ROOM,       4,  3 ; $67
	mapconst SS_ANNE_1F_ROOMS,            8, 12 ; $68
	mapconst SS_ANNE_2F_ROOMS,            8, 12 ; $69
	mapconst SS_ANNE_B1F_ROOMS,           8, 12 ; $6A
	mapconst VOLCANO_1F,                 12, 12 ; $6B
	mapconst VOLCANO_B1F,                21,  8 ; $6C
	...
	mapconst CELADON_MANSION_ROOF,        8,  4 ; $83
