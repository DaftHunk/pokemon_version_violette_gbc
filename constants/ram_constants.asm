; wOptions
DEF BITS_OPTIONS_TEXT_DELAY	  	   EQU %00000111 ; bits 0 to 2
DEF BITS_OPTIONS_TEXT_DELAY_FAST   EQU %00000001 ; bit 1
DEF BITS_OPTIONS_TEXT_DELAY_MEDIUM EQU %00000011 ; bit 3
DEF BITS_OPTIONS_TEXT_DELAY_SLOW   EQU %00000101 ; bit 5
DEF BITS_OPTIONS_SOUND_STEREO	   EQU %00110000 ; bits 4 to 5
DEF BIT_OPTIONS_BATTLE_SHIFT       EQU 6
DEF BIT_OPTIONS_BATTLE_ANIMATION   EQU 7
