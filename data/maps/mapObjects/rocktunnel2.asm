RockTunnel2Object:
	...
	object SPRITE_HIKER, 6, 10, STAY, DOWN, 2, OPP_HIKER, 7
	object SPRITE_BLACK_HAIR_BOY_2, 3, 5, STAY, DOWN, 3, OPP_POKEMANIAC, 2
	object SPRITE_BLACK_HAIR_BOY_2, 20, 21, STAY, RIGHT, 4, OPP_POKEMANIAC, 3
	object SPRITE_HIKER, 30, 10, STAY, DOWN, 5, OPP_HIKER, 11
	object SPRITE_LASS, 14, 28, STAY, RIGHT, 6, OPP_JR_TRAINER_F, 10
	object SPRITE_HIKER, 33, 5, STAY, RIGHT, 7, OPP_HIKER, 12
	object SPRITE_BLACK_HAIR_BOY_2, 26, 30, STAY, DOWN, 8, OPP_POKEMANIAC, 4
