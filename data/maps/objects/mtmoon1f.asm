MtMoon1FObject:
	...
	object SPRITE_NERD, 24, 31, STAY, UP, 4, OPP_SUPER_NERD, 1
	object SPRITE_LASS, 16, 23, STAY, DOWN, 5, OPP_LASS, 6
	object SPRITE_BUG_CATCHER, 7, 22, STAY, DOWN, 6, OPP_BUG_CATCHER, 8
	object SPRITE_BUG_CATCHER, 30, 27, STAY, RIGHT, 7, OPP_BUG_CATCHER, 9
