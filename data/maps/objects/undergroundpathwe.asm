UndergroundPathWEObject:
	...
	db 2 ; objects
	object SPRITE_BIKE_SHOP_GUY, 22, 1, STAY, DOWN, 1, OPP_YOUNGSTER, 1 ; person (youngster #1 is a dummy value for the trainer)
	object SPRITE_BALL, 22, 3, STAY, NONE, 2, M_GENE
