SilphCo5Object:
	...
	object SPRITE_ROCKET, 10, 16, STAY, UP, 2, OPP_ROCKET, 24
	object SPRITE_OAK_AIDE, 8, 3, STAY, RIGHT, 3, OPP_SCIENTIST, 5
	object SPRITE_JUGGLER, 18, 10, STAY, UP, 4, OPP_JUGGLER, 1
	object SPRITE_ROCKET, 28, 4, STAY, UP, 5, OPP_ROCKET, 25
	object SPRITE_BALL, 2, 13, STAY, NONE, 6, TM09_TAKE_DOWN
	object SPRITE_BALL, 4, 6, STAY, NONE, 7, PROTEIN
	object SPRITE_BALL, 14, 15, STAY, NONE, 8, CARD_KEY
