PowerPlantObject:
	...
	object SPRITE_BALL, 16, 5, STAY, NONE, 7, ELECTRODE, 43
	object SPRITE_BALL, 37, 32, STAY, NONE, 8, VOLTORB, 40
	object SPRITE_ZAPDOS, 4, 9, STAY, DOWN, 9, ZAPDOS, 50
	...
	object SPRITE_BALL, 26, 32, STAY, NONE, 13, TM25_THUNDER
	object SPRITE_BALL, 20, 32, STAY, NONE, 14, TM33_REFLECT
	object SPRITE_BALL, 21, 14, STAY, NONE, 15, METAL_COAT
