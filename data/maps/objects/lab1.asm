Lab1Object:
	...
	warp_to 8, 4, CINNABAR_LAB_1_WIDTH ; CINNABAR_LAB_TRADE_ROOM
	warp_to 12, 4, CINNABAR_LAB_1_WIDTH ; CINNABAR_LAB_METRONOME_ROOM
	warp_to 16, 4, CINNABAR_LAB_1_WIDTH ; CINNABAR_LAB_FOSSIL_ROOM
