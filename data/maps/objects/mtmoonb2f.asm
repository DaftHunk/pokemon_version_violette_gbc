MtMoonB2FObject:
	...
	db 9 ; objects
	object SPRITE_NERD, 12, 8, STAY, RIGHT, 1, OPP_SUPER_NERD, 2
	...
	object SPRITE_DOME, 12, 6, STAY, NONE, 6 ; dome
	object SPRITE_OMANYTE, 13, 6, STAY, NONE, 7 ; omanyte
	object SPRITE_BALL, 25, 21, STAY, NONE, 8, HP_UP
	object SPRITE_BALL, 29, 5, STAY, NONE, 9, TM01_MEGA_PUNCH
