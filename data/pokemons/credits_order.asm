...
; to go to the next set of credits texts.
	...
	db CRED_SPECIAL, CRED_TOMISAWA, CRED_KAWAMOTO, CRED_TO_OOTA, $FD
	db CRED_PRODUCERS, CRED_MIYAMOTO, CRED_KAWAGUCHI, CRED_ISHIHARA, $FE
	db CRED_EU_STAFF, $FD
	db CRED_EU_COORD, CRED_MOYSE, $FC
	db CRED_EU_COORD, CRED_PFITZNER, CRED_KRAFT, CRED_KAWAKAMI, $FD
	db CRED_EU_COORD, CRED_EDASAWA, CRED_UESUGI, CRED_YOSHIMURA, $FE
	db CRED_TRANS, CRED_BARDAKOFF, CRED_FLEURY, $FD
	...
	db CRED_BIG_THANKS, CRED_COMMUNITY, CRED_POKERED, $FD
	db $FB, $FF, $FA
