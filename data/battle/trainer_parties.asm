...
KogaData:
	db $FF,42,CROBAT,41,TENTACRUEL,43,VENOMOTH,42,SCYTHER,0
	db $FF,48,CROBAT,49,TENTACRUEL,48,WEEZING,50,VENOMOTH,49,SCYTHER,0
; Rematch
...
; Route 22
	db $FF,55,PIDGEOT,53,NIDORINO,52,GROWLITHE,52,EXEGGCUTE,54,ALAKAZAM,54,BLASTOISE,0
	db $FF,54,PIDGEOT,52,NIDORINO,53,GYARADOS,54,GROWLITHE,52,ALAKAZAM,55,VENUSAUR,0
	db $FF,53,PIDGEOT,54,NIDORINO,54,EXEGGCUTE,52,GYARADOS,52,ALAKAZAM,55,CHARIZARD,0
...
AgathaData:
	db $FF,57,GENGAR,58,CROBAT,57,MAROWAK,58,PARASECT,59,GENGAR,0
; Rematch
