...
; Rematch
	db $FF,64,RAPIDASH,64,FLAREON,64,CHARIZARD_S,64,NINETALES_S,65,ARCANINE,65,MAGMAR,0
...
AgathaData:
	db $FF,57,GENGAR,58,CROBAT,57,MAROWAK,58,MISDREAVUS,59,GENGAR,0
; Rematch
	db $FF,71,UMBREON,71,CROBAT,72,MAROWAK,71,GENGAR,72,MISDREAVUS,73,GENGAR,0
...
JanineData:
; Fuchsia Gym
	db 40,CROBAT,VENOMOTH,NIDOQUEEN,0
