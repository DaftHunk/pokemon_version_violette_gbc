...
; Victory Road 3F
	...
	db $FF,54,WIGGLYTUFF,54,CLEFABLE,54,CHANSEY,57,PERSIAN,0
...
; Rematch
	db $FF,64,OMASTAR,65,STEELIX,64,KABUTOPS,64,GOLEM,64,RHYDON,65,NINETALES_S,0
...
; Rematch
	db $FF,64,HOUNDOOM,64,FLAREON,64,CHARIZARD_S,64,NINETALES_S,65,ARCANINE,65,MAGMAR,0
