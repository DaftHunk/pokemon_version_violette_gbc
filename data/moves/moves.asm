...
MoveEnd:
	...
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, FIGHTING,  85, 15
	...
	move WRAP,         TRAPPING_EFFECT,             25, NORMAL,    90, 20
	...
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT2,         80, ROCK,      95, 10
	...
	move GIGA_DRAIN,   DRAIN_HP_EFFECT,             75, GRASS,    100, 10 ; dafthunk #128
