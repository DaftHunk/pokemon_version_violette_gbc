Route10Object:
	...
	db 6 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, 10, 44, STAY, LEFT, 1, OPP_POKEMANIAC, 5
	object SPRITE_HIKER, 3, 57, STAY, UP, 2, OPP_HIKER, 13
	object SPRITE_BLACK_HAIR_BOY_2, 14, 64, STAY, LEFT, 3, OPP_POKEMANIAC, 6
	object SPRITE_LASS, 7, 25, STAY, LEFT, 4, OPP_JR_TRAINER_F, 11
	object SPRITE_HIKER, 3, 61, STAY, DOWN, 5, OPP_HIKER, 14
	object SPRITE_LASS, 7, 54, STAY, DOWN, 6, OPP_JR_TRAINER_F, 12
