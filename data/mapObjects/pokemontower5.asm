PokemonTower5Object:
	...
	db 2 ; warps
	warp 3, 9, 0, POKEMONTOWER_4F
	warp 18, 9, 0, POKEMONTOWER_6F
	...
	; warp-to
	warp_to 3, 9, POKEMONTOWER_5F_WIDTH ; POKEMONTOWER_4F
	warp_to 18, 9, POKEMONTOWER_5F_WIDTH ; POKEMONTOWER_6F
