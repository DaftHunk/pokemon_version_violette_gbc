RocketHideout4Object:
	...
	object SPRITE_ROCKET, 24, 12, STAY, DOWN, 2, OPP_JESSIE_JAMES, 2
	object SPRITE_ROCKET, 25, 12, STAY, DOWN, 3, OPP_JESSIE_JAMES, 2
	object SPRITE_ROCKET, 11, 2, STAY, DOWN, 4, OPP_ROCKET, 16
	object SPRITE_BALL, 10, 12, STAY, NONE, 5, HP_UP
	object SPRITE_BALL, 9, 4, STAY, NONE, 6, TM04_FLAMETHROWER
