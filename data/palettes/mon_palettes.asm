MonsterPalettes:
	...
	db PAL_GREYBLUEMON   ; MACHOP
	db PAL_GREYBLUEMON   ; MACHOKE
	db PAL_GREYBLUEMON   ; MACHAMP
	db PAL_GREENMON      ; BELLSPROUT
	db PAL_GREENMON      ; WEEPINBELL
	db PAL_GREENMON      ; VICTREEBEL
	db PAL_REDBLUEMON    ; TENTACOOL
	db PAL_REDBLUEMON    ; TENTACRUEL
	...
	db PAL_VIOLETTEMON   ; SHELLDER
	db PAL_VIOLETTEMON   ; CLOYSTER
	...
	db PAL_GREYBLUEMON   ; RHYHORN
	db PAL_GREYBLUEMON   ; RHYDON
	...
	db PAL_VIOLETTEMON   ; STARMIE
	db PAL_MEWMON        ; MR_MIME
	...
	db PAL_VIOLETTEMON   ; CROBAT
	db PAL_BLUEMON       ; KINGDRA
	db PAL_GREYBLUEMON   ; STEELIX
	db PAL_ORANGEMON     ; SCIZOR
	db PAL_REDBLUEMON    ; HOUNDOUR
	db PAL_REDBLUEMON    ; HOUNDOOM
	db PAL_PURPLEMON     ; UMBREON
	db PAL_REDBLUEMON    ; SNEASEL
	db PAL_REDBLUEMON    ; MISDREAVUS
	db PAL_VIOLETTEMON   ; MAROWRATH
	db PAL_VIOLETTEMON   ; LARVITAR
	db PAL_VIOLETTEMON   ; PUPITAR
	db PAL_VIOLETTEMON   ; TYRANITAR
	db PAL_ORANGEMON     ; HOOH
	db PAL_MEWMON        ; MISSINGNO
	db PAL_MEWMON        ; ARMORED_MEWTWO
	db PAL_MEWMON        ; CHARIZARD_S
	db PAL_VIOLETTEMON   ; VENUSAUR_S
	db PAL_BROWNMON      ; ELECTABUZZ_S
	db PAL_VIOLETTEMON   ; NINETALES_S
	db PAL_GREYBLUEMON   ; BLASTOISE_S
	db PAL_VIOLETTEMON   ; SCIZOR_S
	db PAL_BROWNMON      ; MAGMAR_S
