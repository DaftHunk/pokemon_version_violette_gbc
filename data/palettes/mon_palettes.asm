MonsterPalettes:
	...
	db PAL_REDBLUE    ; GLOOM
	db PAL_REDBLUE    ; VILEPLUME
	db PAL_ORANGEMON    ; PARAS
	db PAL_ORANGEMON    ; PARASECT
	db PAL_REDBLUE ; VENONAT
	...
	db PAL_REDBLUE   ; TENTACOOL
	db PAL_REDBLUE   ; TENTACRUEL
	...
	db PAL_REDBLUE       ; SNEASEL
	db PAL_REDBLUE       ; MISDREAVUS
