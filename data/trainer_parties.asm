...
BrunoData:
	db $FF,57,HITMONCHAN,56,POLIWRATH,57,HITMONLEE,56,PRIMEAPE,58,MACHAMP,56,STEELIX,0
; Rematch
	db $FF,71,HITMONCHAN,71,POLIWRATH,70,STEELIX,72,HITMONLEE,72,RHYDON,73,MACHAMP,0
...
KogaData:
	db $FF,42,SCYTHER,42,MUK,41,TENTACRUEL,43,VENOMOTH,0
	db $FF,49,SCYTHER,48,MUK,49,TENTACRUEL,48,WEEZING,50,VENOMOTH,0
; Rematch
	db $FF,64,SCIZOR,64,MUK,64,TENTACRUEL,65,WEEZING,64,ARBOK,65,VENOMOTH,0
...
LoreleiData:
	db $FF,56,SLOWBRO,55,CLOYSTER,55,DEWGONG, 56,JYNX,57,LAPRAS,55,SNEASEL,0
; Rematch
...
AgathaData:
	db $FF,57,GENGAR,58,GOLBAT,57,MAROWAK,58,MISDREAVUS,59,GENGAR,57,UMBREON,0
; Rematch
	db $FF,71,UMBREON,71,GOLBAT,72,MAROWAK,71,GENGAR,72,MISDREAVUS,73,GENGAR,0

LanceData:
	db $FF,61,DRAGONITE,60,GYARADOS,60,CHARIZARD,61,AERODACTYL,62,DRAGONITE,60,KINGDRA,0
; Rematch
